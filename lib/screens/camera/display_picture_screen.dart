...
/// A widget that displays the picture and detected food inside the picture, given file path.
/// Google AIY model and TFLite model are used to detect food in the picture.
                      ...
                      ? ElevatedButton(
                          onPressed: () async {
                            try {
                              ...
                              final stream = FoodGuru()
                                  .provider
                                  .sendMessageStream(
                                      'Find recipe for ${snapshot.data!.first}');
                          ...
                          child:
                              Text('ค้นหาสูตรสำหรับ ${snapshot.data!.first}'))
